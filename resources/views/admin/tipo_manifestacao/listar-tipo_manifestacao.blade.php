    ...
    <div class="card p-4 shadow">
        <div class="col-lg-12 d-flex justify-content-between align-itens-center">
            <h2>Tipo de Manifestação<h2>
                    <a href="{{ route('vis-cadastro-tipo_manifestacao') }}" class="btn btn-success">Cadastrar</a>
        </div>
        @if (session('mensagem'))
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($tipo_manifestacao->ativo)
                                    <a class="btn"
                                        href="{{ route('ativar-tipo_manifestacao', ['id' => $tipo_manifestacao->id]) }}">
                            ...
                            <td class="col-md-1">
                                <div class="d-flex justify-content-evenly">
                                    <a href="{{ route('visualizar-tipo_manifestacao', ['id' => $tipo_manifestacao->id]) }}">
                                        <i class="fa-xl fa-solid fa-magnifying-glass text-primary"></i>
                                    </a>
                                    <a href="{{ route('vis-editar-tipo_manifestacao', ['id' => $tipo_manifestacao->id]) }}">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="" action="{{ route('deletar-tipo_manifestacao') }}" method="POST">
