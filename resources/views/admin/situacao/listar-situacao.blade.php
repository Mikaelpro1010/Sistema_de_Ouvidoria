...
<div class="card p-4 shadow">
        <div class="col-lg-12 d-flex justify-content-between align-itens-center">
            <h2>Situação<h2>
            <a href="{{route('vis-cadastro-situacao')}}" class="btn btn-success">Cadastrar</a>
        </div> 
        @if (session('mensagem'))
                ...
                @if (isset($situacoes))
                    @foreach ($situacoes as $situacao)
                        <tr>
                            ...
                            <td>
                                @if($situacao->ativo)
                                <a  class="btn" href="{{ route('ativar-situacao', ['id' => $situacao->id]) }}">
                            ...
                            <td class="col-md-1">
                                <div class="d-flex justify-content-evenly">
                                    <a href="{{ route('visualizar-situacao', ['id' => $situacao->id]) }}">
                                        <i class="fa-xl fa-solid fa-magnifying-glass text-primary"></i>
                                    </a>
                                    <a href="{{ route('vis-editar-situacao', ['id' => $situacao->id]) }}">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="" action="{{ route('deletar-situacao') }}" method="POST">
